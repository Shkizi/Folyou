var tymysql={
    ...
    module.exports.datevariable=(date)=>{
        return (date ===  tymysql.TIMESTAMP || date ===  tymysql.DATE || date ===  tymysql.TIME || date ===  tymysql.DATETIME || date ===  tymysql.TIMESTAMP2 || date ===  tymysql.DATETIME2 || date ===  tymysql.TIME2);
    }
    module.exports.mysqltypes = tymysql;