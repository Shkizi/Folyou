                              ...
                              <div className="w-100 HomeCarrousel-Background">
                                ...
                                <Col xs="5" sm="5" md="5" lg="5" xl="5">
                                    <div className="container HomeCarrousel-Image-Container">
                                      <Image className="HomeCarousel-Image" src={S.baseURL()+"public/anexes/sheets/"+val.defaultImageSheet} thumbnail />
                                    </div>
                                </Col>
                                <Col xs="7" sm="7" md="7" lg="7" xl="7">
                                    <div className="HomeCarrousel-Text-Container">
                                      <div className="HomeCarrousel-Text-Project-Name">{val.nameSheet}</div>
